...
function App() {
   ...
   return (
      <ListContext.Provider value={{ data, setData }}>
         <div
            className={`h-screen   @container bg-slate-400 dark:bg-slate-600 `}
         >
            <div className='width-class relative  h-full flex-row border border-yellow-400 dark:border-yellow-600 '>
