...
const FormComp = ({ resHead }: Props) => {
   ...
   return (
      <div className='absolute top-12 z-50 min-h-max  w-full  '>
         <form
            className='form-width mx-auto min-h-max flex-col rounded-xl border-2 border-green-600 px-8 py-3 bg-slate-800  '
            onSubmit={onSubmit}
         >
            {/* {show action title} */}
            <h3 className='my-4 content-center font-serif text-base   font-medium text-slate-100   @4xl:text-lg @5xl:text-lg'>
            ...
            <div className='mb-5'>
               ...
               <div className='input-class input-bg  size-btn '>
